    ...
    while True:
        try:
            ...
            if profil.get("ayirt_edici"):
                ...
                # NOT: kazanan profil artık Telegram'a atılMIYOR — aynı satır tekrar
                # tekrar gönderilip kanalı dolduruyordu (kullanıcı sitemi). Profil
                # yalnızca aşağıdaki pattern-sinyal üretiminde kullanılır. Sadece BTC/ETH.
