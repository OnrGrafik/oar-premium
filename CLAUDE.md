...
- SONUÇLAR (2019-2025, BTC+ETH): STİL-3 ELENDİ (WR%23.9 n3513 OOS−0.062) · STİL-4 ELENDİ (WR%46.7 n826 OOS−0.097) — mekanik hali (footprint/VPFR onaysız) kârsız; kullanıcının manuel onay katmanı kritikmiş. ÇOKLU ŞAMPİYON: 2 SAĞLAM stil çıktı ✅ fade=[absorpsiyon+range_rejimi+htf_vwap] (OOS60/holdout51) + trend=[poc_taraf+absorpsiyon] (OOS60/holdout54) → portföyde 2 bağımsız şampiyon. (Portföy json'da beklenti/equity alanları boş — alan-adı uyumsuzluğu, düzeltilecek.)
